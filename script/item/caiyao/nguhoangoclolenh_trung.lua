...
{
	-- 1 tuan
	["6,1,4986"] = {szName="Håi thiªn t¸i t¹o ®¬n", tbProp={1, 8, 0, 4, 0, 0},nBindState=-2},
}
...
function main(nItemIndex)
	...
	AskClientForNumber("huitianjinlang_getpotion", 0,(2500-nCount), "Xin mêi nhËp sè cÇn rót")
...
function huitianjinlang_getpotion(nPickCount)
	...
	if IsMyItem(nItemIndex) == 1 then
		...
		if tbAwardTemplet:GiveAwardByList(%tbItem[szItemId], "Ngò hoa ngoc lo lenh (Trung)") == 1 then
...
function GetDesc(nItemIndex)
	...
	return format("Cßn d­:  <color=yellow>%d<color>",(2500 - nCount))
end
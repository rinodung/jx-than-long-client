...
SKILLS={
	--Îäµ±
	nulei_zhi={ --Né L«i ChØ 	C«ng kÝch néi c«ng 	153	
		lightingdamage_v={
			[1]={{1,1},{20,5}},
			[3]={{1,1},{20,75}}
		},
...
--		skill_showevent={{{1,0},{5,0},{5,2},{20,2}}},
	...
	qiwudang150={ --T¹o Hãa Th¸i Thanh	C«ng kÝch néi c«ng 	1078
...
--		physicsenhance_p={{{1,15},{20,180}}},
	...
	wudang120={ --XuÊt ø BÊt NhiÔm	chñ ®éng hç trî 716 - Kü n¨ng 120 Vâ §ang

...
SKILLS={
	...
	xiaoyaojianfa ={ --Tiªu dao kiÕm ph¸p
		addphysicsdamage_p={{{1,15},{20,400}},{{1,-1},{2,-1}},{{1,0},{2,0}}},
		deadlystrikeenhance_p={{{1,5},{20,20}},{{1,-1},{2,-1}}}
	},

	yigonghuanyu={ --Di cung ho¸n vò
		addphysicsdamage_p={{{1,20},{20,340}},{{1,18*60},{20,18*60}}},
		deadlystrikeenhance_p={{{1,6},{20,36}},{{1,18*60},{20,18*60}}},
	...
	sataliuxing={ --T¸p ®¹p l­u tinh
		-- cost_sp={
			...
			-- {{1,8},{20,3},{21,3}}, -- ³Ô¼¸¸ö
		-- },
		skill_param1_v={{{1,480},{15,512},{15,512}}},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_mintimepercast_v={{{1,25*18},{20,20*18},{30,15*18},{31,10*18},{32,10*18}}},
		skill_desc=
			function(level)
	...
	yinanbaima={ --Ng©n yªn b¹ch m·
		fastwalkrun_p={{{1,12},{20,52}},{{1,-1},{20,-1}}},
	},
	...
	qianliduxing={ --Thiªn lý ®éc hµnh
		...
		castspeed_v={{{1,26},{30,81},{33,86},{35,101},{36,103}},{{1,-1},{30,-1}}},
...
------------------------------------------------------------------------------------------------------------
	jianjuefuyun_2={ --Phï v©n kiÕm quyÕt
		physicsenhance_p={{{1,5},{15,100},{20,150}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		lightingdamage_v={
			[1]={{1,39},{15,150},{20,373}},
			[3]={{1,39},{15,150},{20,373}}
		},
		stun_p={{{1,5},{20,15},{21,15}},{{1,1},{20,12},{21,12}}},
		missle_speed_v={{{1,28},{20,32},{21,32}}},
		skill_attackradius={{{1,448},{20,512},{21,512}}},
	...
	loichandaidia={ --loi chan dai dia
		...
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		stun_p={{{1,5},{20,10},{21,10}},{{1,1},{20,12},{21,12}}},
		lightingdamage_v={
			[1]={{1,39},{15,100},{20,200}},
			[3]={{1,39},{15,100},{20,350}}
		},
	},
	...
	danzhichishang={ --§¹m chÝch tr× tr­êng
		autoattackskill={
			...
			{{1,-1},{20,-1}},
			{{1,20*18*256 + 1},{30,20*18*256 + 16},{31,20*18*256 + 16}}--ÀäÈ´Ê±¼ä*256+¸ÅÂÊ
		},
		skill_desc=
			function(level)
				...
				"<color=water>T¨ng c«ng kÝch kü n¨ng <color=orange>"..floor(Link(level,SKILLS.danzhichishang_Buff.skill_enhance[1])).."%<color>\n"..
				"Duy tr× <color=orange>"..floor(Link(level,SKILLS.danzhichishang_Buff.skill_enhance[2]) / 18).."<color> gi©y"
			end,
		skill_skillexp_v={
			{
				{1,17851239},
	...
	danzhichishang_Buff={ --à¢ÖË³Öõü_Buff
		skill_enhance={{{1,1},{20,20}},{{1,15*18},{20,15*18},{21,15*18}}},
	},

	shibuyisha={ --ThËp bé nhÊt s¸t
		physicsenhance_p={{{1,25},{20,300}}},
		seriesdamage_p={{{1,20},{15,20},{20,50},{21,52}}},
		lightingdamage_v={
			[1]={{1,39},{15,110},{20,230}},
			[3]={{1,39},{15,110},{20,450}}
		},
		...
		skill_mintimepercast_v={{{1,20*18},{20,15*18},{30,10*18},{31,10*18}}},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_desc=
			function(level)
	...
	xiaoyaoqinfa={ --Tiªu dao cÇm ph¸p
		addlightingmagic_v={{{1,20},{20,400}},{{1,-1},{2,-1}}}
	},
	...
	luoyanpingsha={ --L¹c nh¹n b×nh sa
		...
		-- skill_desc=
			-- function(level)
				...
				-- "Duy tr× <color=orange>"..floor(Link(level,SKILLS.xiaoyaoyu.addlightingmagic_v[2])/18).." gi©y<color>\n"
			-- end,
	},
	xiaoyaoyu={ --Tiªu dao khóc
		addlightingmagic_v={{{1,15},{20,200}},{{1,150*18},{20,150*18}}},
		skill_eventskilllevel={{{1,1},{20,20}}},
	},
	...
	guanglingsan={ --Qu¶ng l¨ng t¸n
		...
		seriesdamage_p={{{1,10},{20,50},{21,52}}},
		skill_misslenum_v={{{1,1},{20,3},{25,4},{29,5},{30,5}}},
	...
	gaoshanliushui={ --Ng¹o s¬n l­u thñy
		...
		stun_p={{{1,2},{20,20},{21,20}},{{1,1},{20,12},{21,12}}},
		addskilldamage1={
			[1]={{1,1911},{2,1911}},
			[3]={{1,1},{20,70}}
		},

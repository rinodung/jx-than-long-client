-------------------------------------------------------------------------
-- FileName		:	admin.lua - C¸i Bang
-- Author		:	jxdocs.com
-- CreateTime	:	2005-04-06 23:17:18
-- Desc			:	/jxser/server1/script/skill/special/admin.lua
-------------------------------------------------------------------------
...
SKILLS={
	...
	mengdie={ --Mong diep
		...
		physicsres_p={{{1,10},{20,50}},{{1,18*120},{20,18*180}}},
		poisonres_p={{{1,10},{20,39}},{{1,-1},{2,-1}}},
		coldres_p={{{1,10},{20,50}},{{1,18*20},{20,18*90}}},
		fireres_p={{{1,10},{20,50}},{{1,18*20},{20,18*90}}},
		lightingres_p={{{1,10},{20,50}},{{1,18*20},{20,18*90}}},

...
SKILLS={
	...
	wangu_shixin={ --V¹n §éc Thùc T©m	Chñ ®éng hç trî c«ng kÝch	73
		poisontimereduce_p={{{1,-100},{20,-600}},{{1,18*45},{20,18*120}}},
		skill_cost_v={{{1,40},{20,40}}}
	},
	...
	wudu_qijing={ --Ngò §éc Kú Kinh TrÊn Ph¸i Hç trî phßng ngù - chñ ®éng	75
		...
		poisonenhance_p={{{1,12},{30,30},{33,33},{35,35},{38,38}},{{1,-1},{2,-1}}},--thêi gian ®éc ph¸t
		deadlystrikeenhance_p={{{1,5},{30,85}},{{1,-1},{2,-1}}},--tÊn c«ng chÝ m¹ng

...
function showrandraskdesc(nTaskIdx, nTaskGenre)
	...
	elseif (myTaskType==4) then
		...
		myTaskMainInfo = "§Õn <color=yellow>"..myTaskOrder.."<color> t×m <color=yellow>"..myTaskInfo1.."<color> quyÓn <color=gold>".. myTaskInfo3.."<color> vÒ cho D· TÈu!".." B¹n hiÖn ®· thu thËp ®­îc <color=yellow>"..GetTask(1025).."<color> tÊm <color=gold>"..myTaskInfo3.."<color>";
